...
export function FollowingPointerDemo({ blogContent }: { blogContent: BlogContent }) {
    return (
        <div className="w-80 mx-auto mb-4">
            ...
            >
                <div className="relative overflow-hidden h-full rounded-2xl transition duration-200 group bg-inherit hover:shadow-xl border border-zinc-100">
